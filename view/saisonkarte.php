...
//	$breadcrumb->add('push', push_href_link(FILENAME_DEFAULT,'','NONSSL'));
	...
	$breadcrumb->add('Saisonkarte', push_href_link(FILENAME_SAISONKARTE,'','NONSSL'));
//	$breadcrumb->add('Neukundeninformation', push_href_link(FILENAME_NEUKUNDENINFORMATION));
...
<div class="grid_12">
	<?php 
		include(DIR_WS_CONTENT . FILENAME_SAISONKARTE);
	?>
</div>
