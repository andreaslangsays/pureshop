...
define('HEAD_TITLE_TAG_ALL','Aerografia.cat : ');
define('HEAD_DESC_TAG_ALL','Aerografia.cat : We offer you an extensive range of products for the airbrushing - Airbrushes, compressors, templates, colours, etc.');
define('HEAD_KEY_TAG_ALL','airbrushes, compressors, createx, autoair, schmincke, templates, colours,iwata, mask');
...
define('HEAD_DESC_TAG_DEFAULT','- Aerografia.cat : We offer you an extensive range of products for the airbrushing - Airbrushes, compressors, templates, colours, etc.');
define('HEAD_KEY_TAG_DEFAULT','- airbrushes, compressors, createx, autoair, schmincke, templates, colours,iwata, mask');
