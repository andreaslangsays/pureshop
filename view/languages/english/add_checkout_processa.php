...
define('BG_TOP_EMAIL', '#F9F9F9');    //Image de votre fond background pour le entete de email. Remplacez pixel_trans.gif par votre image de fond...cette image doit se situer dans votre repertoire catalog/images, si vous en avez pas ce sera alors la couleur de fond cidessous qui apparaitra.
...
define('CATEGORY_PERSONAL', '<b><u>Ihre pers&ouml;nlichen Informationen</u> :</b>');
define('EMAIL_TEXT_DEAR', '<br><br>Guten Tag,');        //texte devant le nom de la personne
define('MESSAGE_SOCIETY', ' Wir danken für Ihr Vertrauen in die Bruesselser Kakaor&ouml;sterei. <br> Wir stehen Ihnen jederzeit zur Verfügung und hoffen, dass Sie uns bald wieder beehren.<br><br>Das Team der  ');
define('EMAIL_TEXT_USER', 'Ihre e-mail Adresse');     //texte devant le mail de la personne
...
define('EMAIL_TEXT_ORDER_NUMBER', '<b>Bestellnummer </b>:');  //def en francais
define('EMAIL_TEXT_INVOICE_URL', 'Details Ihrer Bestellung');  //def en francais
...
define('EMAIL_TEXT_FOOTERR', 'Bei Fragen und Problemen k&ouml;nnen Sie sich jederzeit an uns wenden');     //texte fin de mail apres le nom de votre boutique
...
define('EMAIL_TEXT_CUSTID', 'Ihre Kundennummer');
