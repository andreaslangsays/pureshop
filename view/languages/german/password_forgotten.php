...
define('TEXT_MAIN', 'Sollten Sie Ihr Passwort nicht mehr wissen, geben Sie bitte unten Ihre hinterlegte  eMail-Adresse ein um umgehend ein neues Passwort per eMail zu erhalten.');
