...
$TARGET_EMAIL = array(EMAIL_NAME."@Bruesselser-Kakaoroesterei\.de$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT", "andreas.lang@Bruesselser-Kakaoroesterei.de");

            /* Help: http://www.tectite.com/fmdoc/site_domain.php */
$SITE_DOMAIN = "http://Bruesselser-Kakaoroesterei.de/shop";           // your website domain name
...
$TEMPLATEDIR = "./includes/formmail/templates";                  // directory for template files; empty string
...
$FORM_INI_FILE = "includes/formmail/formmail.ini";
...
else
{
    ...
    if (!$bGotGoodUrl)
    {
        // changed by pawel, 27.11.2012
		if ($_POST['referrer'] == "rueckrufservice.php")
			Redirect('http://www.if-bi.com/shop/rueckrufservice.php?result=success', '');
		else if ($_POST['referrer'] == "contact_us.php")
			Redirect('http://www.if-bi.com/shop/contact_us.php?result=success', '');
		else if ($_POST['referrer'] == "katalog.php")
			Redirect('http://www.if-bi.com/shop/katalog.php?result=success', '');
			
		else if ($bGotGoodTemplate)
