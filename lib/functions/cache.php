...
// Cache the categories box
  function push_cache_categories_box($auto_expire = false, $refresh = false) {
...
// Cache the manufacturers box
  function push_cache_manufacturers_box($auto_expire = false, $refresh = false) {
    global $_GET, $language;

    $manufacturers_id = '';
    //if (isset($_GET['manufactuers_id']) && push_not_null($_GET['manufacturers_id'])) {
...
// Cache the also purchased module
  function push_cache_also_purchased($auto_expire = false, $refresh = false) {
...
// Cache the also Xell module
  function push_cache_xsell_products($auto_expire = false, $refresh = false) {
    global $_GET, $language, $languages_id;
