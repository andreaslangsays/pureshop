<?php
/*
  $Id: email.php,v 1.2 2007-12-21 00:48:54 popelar Exp $
 ...
 */
    ...
    function add_text($text = '') {
      ...
      $this->text = push_convert_linefeeds("xxCRLFxx", $this->lf, $this->text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      ...
      $this->html_text = push_convert_linefeeds("xxCRLFxx", $this->lf, $this->html_text);
