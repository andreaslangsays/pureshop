...
*/
  ...
  class language {
    ...
    function language($lng = '') {
      ...
      $languages_query = push_db_query("select languages_id, name, code, image, directory from " . TABLE_LANGUAGES . " order by sort_order");
      while ($languages = push_db_fetch_array($languages_query)) {
    ...
    function set_language($language) {
      if ( (push_not_null($language)) && (isset($this->catalog_languages[$language])) ) {
