 ...
 */
    ...
    function add_text($text = '') {
      $this->text = push_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = push_convert_linefeeds(array("\r\n", "\n", "\r"), '<br>', $html);
      $this->html_text = push_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (push_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((push_not_null($this->attachments)) ? true : false);
      $html_images = ((push_not_null($this->html_images)) ? true : false);
      $html = ((push_not_null($this->html)) ? true : false);
      $text = ((push_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (push_not_null($this->html_text)) {
/* HPDL PHP3 */
 ...
 */
    ...
    if (EMAIL_TRANSPORT == 'smtp') {
			   ...
			   $headers["Bcc"] = "bestellung@Bruesselser-Kakaoroesterei.de";
			   $params["host"] = "195.167.223.181";
			   $params["port"] = "25";
			   $params["auth"] = true;
			   $params["username"] = "web1_bestellung";
			   $params["password"] = "bestell2k";

			   // Create the mail object using the Mail::factory method
			   $mail_object =& Mail::factory("smtp", $params);
			   return $mail_object->send("$to_addr, YOUR_BCC_ADDRESS@YOURDOMAIN.COM", $headers, $this->output);
