  ...
  class navigationHistory {
    ...
    function add_current_page() {
      global $_SERVER, $_GET, $_POST, $request_type, $cPath;
		if(!is_array($this->snapshot)||!is_array($this->path))
		{
			$this->reset();	
		}
    ...
    function debug() {
      ...
      if (sizeof($this->snapshot) > 0) {
        ...
        echo $this->snapshot['mode'] . ' ' . $this->snapshot['page'] . '?' . push_array_to_string($this->snapshot['get'], array(push_session_name())) . '<br>';
      }
    }
