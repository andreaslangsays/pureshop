...
define('TEXT_INFORMATION', '<p style="color:#cc0000">Leider funktioniert Sofortueberweisung.de derzeit noch nicht mit Ihrem
Kreditinstitut.</p><p style="color:#cc0000"> Wir werden uns bemühen, dass auch Sie in Kürze diesen
Paymentdienst nutzen können.<br><br></p>
<p style="line-height:24px;">
Bitte überweisen Sie uns den Rechnungsbetrag auf das folgende Konto:<br><br>
' . $sofortueberweisung_payto);
?>