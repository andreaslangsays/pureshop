...
// class methods
    function update_status() {
      global $order, $customer_id, $customer_group_id;
	  ...
	  if (MODULE_PAYMENT_GERMANBT_ENABLE_AFTER == 'true'){
	    $test_query = push_db_query("select count(*) as total from " . TABLE_ORDERS . " where customers_id='" . $customer_id . "' AND orders_status = " . MODULE_PAYMENT_GERMANBT_ENABLE_AFTER_ORDER_STATUS );
